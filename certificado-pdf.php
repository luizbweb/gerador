...
if($envio)
 echo "<h2 align=center><br><br>O Certificado foi enviado com para o email ".$email."<br> Em caso de d�vidas envie email para contato@waw.net.br</h2>";
else
 echo "<h2 align=center><br><br>A mensagem n�o pode ser enviada...<br>Envie email para contato@waw.net.br</h2>";
exit;
?>	